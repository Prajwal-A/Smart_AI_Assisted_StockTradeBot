...
# # ==============================
# async def get_historical_data(symbol: str, period="1y"):
#     try:
...
#     # ==============================
#     # RSI-Based Momentum Logic
#     # ==============================

#     if np.isnan(rsi):
#         momentum = "UNKNOWN"
#     if rsi < 25:
#         momentum = "EXTREME_OVERSOLD"
#     elif rsi < 35:
#         momentum = "OVERSOLD"
#     elif rsi < 45:
...
#     if trend.startswith("STRONG_UPTREND") and rsi < 45:
#         signal = "BUY"

#     elif trend == "PULLBACK_IN_UPTREND" and rsi < 35:
#         signal = "STRONG_BUY"

#     elif trend.startswith("STRONG_DOWNTREND") and rsi > 55:
#         signal = "SELL"

#     elif trend == "BOUNCE_IN_DOWNTREND" and rsi > 65:
#         signal = "STRONG_SELL"
...
#     # Override signals in extreme conditions
#     if risk == "EXTREME":
#         signal = "AVOID_TRADE"
...
#         "volatility": round(float(volatility), 4) if not np.isnan(volatility) else None,
#         "risk_lvl": risk
#     }
